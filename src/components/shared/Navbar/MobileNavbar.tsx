              ...
              <div className="mt-6 flex flex-1 flex-col justify-between ">
                <nav className="-mx-3 space-y-6 ">
                  <div className="space-y-5">
                    <Link
                      className={currentPath === "/" ? "NavMobile bg-color-yellow text-black" : "NavMobile"}
                      href="/"
                    >
                    ...
                    <Link
                      className={currentPath === "/about" ? "NavMobile bg-color-yellow text-black" : "NavMobile "}
                      href="/about"
                    >
                    ...
                    <Link
                      className={currentPath === "/services" ? "NavMobile bg-color-yellow text-black" : "NavMobile "}
                      href="/about"
                    >
                      <MdMiscellaneousServices className="size-6" aria-hidden="true" />
                      <span className="mx-2 text-sm font-medium">
                      Services
                      </span>
                    </Link>
